...
let JSFunctionService = class JSFunctionService {
    ...
    getAllJSFunctions(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/JSFunction/getAllJSFunctions`, body, {
    ...
    createJSFunction(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/JSFunction/createJSFunction`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
