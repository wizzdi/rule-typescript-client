...
let RulesService = class RulesService {
    ...
    clearLog(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/Rules/clearLog`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    createRule(body, authenticationKey, observe = 'body', reportProgress = false) {
        let headers = this.defaultHeaders;
        if (authenticationKey !== undefined && authenticationKey !== null) {
            headers = headers.set('authenticationKey', String(authenticationKey));
        }
    ...
    getAllRules(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/Rules/getAllRules`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
