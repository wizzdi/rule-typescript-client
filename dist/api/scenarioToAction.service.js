...
let ScenarioToActionService = class ScenarioToActionService {
    ...
    createScenarioToAction(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/ScenarioToAction/createScenarioToAction`, body, {
    ...
    getAllScenarioToAction(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/ScenarioToAction/getAllScenarioToActions`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    updateScenarioToAction(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.put(`${this.basePath}/plugins/ScenarioToAction/updateScenarioToAction`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
